...
lua_func = lua.eval('''
        ...
        for i = 1, bot.roll_number do
            ...
            python.eval('bot1.attribute_update()')
            print(string.format('stake: %2.8f %s balance: %8.8f wager: %8.8f roll: %2.2f nonce: %d bets: %d chance %2.2f total wins: %d ',previousbet,win2,bot.balance,bot.wager,bot.roll,(bot.nonce-1),bets,lastchance, win3))
            lastchance = chance
